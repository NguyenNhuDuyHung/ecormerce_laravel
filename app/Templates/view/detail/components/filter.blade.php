        ...
        <div class="uk-flex uk-flex-middle uk-flex-space-between">
            ...
            <div class="action">
                <div class="uk-flex uk-flex-middle">
                    ...
                    <select name="{module}_catalogue_id" class="form-control setupSelect2 mr10">
                    ...
                    <a href="{{ route('{module}.create') }}" class="btn btn-danger"><i class="fa fa-plus mr5"></i>
                        {{ __('message.{module}.create.title') }}
                    </a>
                </div>
            </div>
        </div>
