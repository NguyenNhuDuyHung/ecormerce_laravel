            ...
            $(document).on("click", ".changeStatusAll", function (e) {
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        if (res.flag) {
                            let cssActive1 =
                                "box-shadow: rgb(26, 179, 148) 0px 0px 0px 16px inset; border-color: rgb(26, 179, 148); background-color: rgb(26, 179, 148); transition: border 0.4s, box-shadow 0.4s, background-color 1.2s;";
                            let cssActive2 =
                                "left: 20px; transition: background-color 0.4s, left 0.2s; background-color: rgb(255, 255, 255);";
