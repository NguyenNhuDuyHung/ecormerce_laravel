<div class="ibox">
    ...
    <div class="ibox-content">
        @php
            // Kiểm tra xem $album có phải là chuỗi trước khi giải mã
            $albumTemplate = !empty($album) && is_string($album) ? json_decode($album, true) : [];

            // Nếu $albumTemplate có dữ liệu thì sử dụng, ngược lại lấy giá trị cũ từ form ('old')
